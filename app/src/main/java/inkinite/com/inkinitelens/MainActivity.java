package inkinite.com.inkinitelens;
...
public class MainActivity extends AppCompatActivity {
    ...
    ImageView ivImage;
    final String FILE_LOCATION = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!OpenCVLoader.initDebug()) {
            ...
            Log.e("OPENCV_INIT","Something went wrong!");
        ...
        bClickImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                File imagesFolder =  getExternalStoragePublicDirectory("DIRECTORY_PICTURES");//new File(FILE_LOCATION);
                imagesFolder.mkdirs();
    ...
    static double calcWhiteDist(double r, double g, double b){
     ...
     Bitmap bitmapProcessing(ArrayList<Point> corners,ArrayList<Point> result_pts,Mat quad)
    {
    ...
    public String getPage()
    {
        ...
        Bitmap b = bitmapProcessing(corners,result_pts,quad);
